...
build:
	go build github.com/wangxn2015/onos-lib-go/pkg/...
...
test: mod-lint build linters license
	go test -race github.com/wangxn2015/onos-lib-go/pkg/...

jenkins-test:  # @HELP run the unit tests and source code validation producing a junit style report for Jenkins
jenkins-test: mod-lint build linters license
	TEST_PACKAGES=github.com/wangxn2015/onos-lib-go/pkg/... ./build/build-tools/build/jenkins/make-unit

protos: # @HELP compile the protobuf files (using protoc-go Docker)
	docker run -it -v `pwd`:/go/src/github.com/wangxn2015/onos-lib-go \
		-w /go/src/github.com/wangxn2015/onos-lib-go \
...
clean:: # @HELP remove all the build artifacts
	go clean -testcache github.com/wangxn2015/onos-lib-go/...
