...
build:
	go build github.com/wangxn2015/onos-lib-gopkg/...
...
test: build deps license_check linters
	go test -race github.com/wangxn2015/onos-lib-gopkg/...

jenkins-test:  # @HELP run the unit tests and source code validation producing a junit style report for Jenkins
jenkins-test: build deps license_check linters
	TEST_PACKAGES=github.com/wangxn2015/onos-lib-gopkg/... ./build/build-tools/build/jenkins/make-unit
